...
void kernel_kutils_gdt_setup() {
    ...
    kprintf("DEBUG: Initializing GDT...\n");
...
void kernel_kutils_mem_setup(boot_t __bootinfo) {
    ...
    kprintf("DEBUG: Initializing Kernel Page Frame Allocator...\n");
    kernel_allocator_initialize();

    kprintf("DEBUG: Locking Kernel Pages...\n");
...
void kernel_kutils_int_setup() {
    kprintf("DEBUG: Initializing Interrupts...\n");
